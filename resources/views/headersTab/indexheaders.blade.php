                    ...
                    <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{$post->test_header_1_id}}</td>
                                <td>{{$post->test_header_2_id}}</td>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input type="text" name="" value="{{$post->test_header_1_id}}" placeholder="Header1" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="container mt-2">
                            <div class="row">
                                <div class="col">
                                     <input type="text" name="" value="{{$post->test_header_2_id}}" placeholder="Header2" disabled>
                                </div>
                            </div>
                        </div>
